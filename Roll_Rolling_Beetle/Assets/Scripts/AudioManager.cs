...
{
    BUTTON, CACA_COLISIONANDO, MUERTE_MANTIS, MUERTE_GUSANO, MUERTE_JUGADOR, GAME_OVER, ATAQUE_MANTIS, 
    ATAQUE_GUSANO, ATAQUE_PAJARO, WARNING_PAJARO, POPO_ENTREGADA, SLIDER_LISTO, POPO_ARROJADA, CAMINANDO, BONUS
}
